...
class NeuromusicmmSupabaseUser extends BaseAuthUser {
  NeuromusicmmSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> neuromusicmmSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = NeuromusicmmSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
