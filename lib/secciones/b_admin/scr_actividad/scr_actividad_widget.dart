...
import 'scr_actividad_model.dart';
export 'scr_actividad_model.dart';

class ScrActividadWidget extends StatefulWidget {
  const ScrActividadWidget({super.key});

  @override
  State<ScrActividadWidget> createState() => _ScrActividadWidgetState();
}

class _ScrActividadWidgetState extends State<ScrActividadWidget> {
  late ScrActividadModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ScrActividadModel());
                                                          ...
                                                          Padding(
                                                            ...
                                                            child: Row(
                                                              ...
                                                              children: [
                                                                CampoWidget(
                                                                  key: Key(
                                                                      'Keyoa3_${columnIndex}_of_${columnCatEscuelasRowList.length}'),
                                                                ...
                                                                CampoWidget(
                                                                  key: Key(
                                                                      'Keyivw_${columnIndex}_of_${columnCatEscuelasRowList.length}'),
                                                                  texto: columnCatEscuelasRow
                                                                      .nomContacto!,
                                                                  ancho: 250,
                                                                  tamLetra: 14,
                                                                ...
                                                                CampoDerWidget(
                                                                  key: Key(
                                                                      'Keyi1e_${columnIndex}_of_${columnCatEscuelasRowList.length}'),
                                                                  texto: columnCatEscuelasRow
                                                                      .telContacto!,
                                                                  ancho: 120,
                                                                  tamLetra: 14,
                                                                ...
                                                                builder: (context,
                                                                  ...
                                                                  return Wrap(
                                                                    ...
                                                                    children: List.generate(
                                                                      ...
                                                                      return CampoWidget(
                                                                        key: Key(
                                                                            'Key0lc_${wrapIndex}_of_${wrapCatPlantelesRowList.length}'),
                                                                        texto: wrapCatPlantelesRow
                                                                            .nomPlantel!,
                                                                        ancho:
                                                                            145,
                                                                        tamLetra:
