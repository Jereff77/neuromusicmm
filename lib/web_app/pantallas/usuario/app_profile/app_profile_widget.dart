...
import 'app_profile_model.dart';
export 'app_profile_model.dart';

class AppProfileWidget extends StatefulWidget {
  const AppProfileWidget({super.key});
...
class _AppProfileWidgetState extends State<AppProfileWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AppProfileModel());
            ...
            Padding(
              ...
              child: FutureBuilder<List<CatUsersRow>>(
                ...
                builder: (context, snapshot) {
                  ...
                  List<CatUsersRow> contPerfilCatUsersRowList = snapshot.data!;

                  final contPerfilCatUsersRow =
                      contPerfilCatUsersRowList.isNotEmpty
                          ? contPerfilCatUsersRowList.first
                          : null;
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              Text(
                                'Hola ${FFAppState().userActivo.nombre}',
                                      ...
                                      child: Padding(
                                        ...
                                        child: TextFormField(
                                          controller:
                                            ...
                                            text: contPerfilCatUsersRow?.nombre,
                                          ),
                                      ...
                                      child: Padding(
                                        ...
                                        child: TextFormField(
                                          controller: _model
                                              ...
                                              TextEditingController(
                                            text: contPerfilCatUsersRow
                                                ?.apellido1,
                                          ),
                                          focusNode:
                                              _model.txtApellidoFocusNode,
                                          autofocus: true,
                                          obscureText: false,
                                          decoration: InputDecoration(
                                            labelText: 'Apellido:',
                                      ...
                                      onPressed: () async {
                                        ...
                                        await CatUsersTable().update(
                                          data: {
                                            ...
                                            'apellido1': _model
                                                .txtApellidoTextController.text,
                                          },
