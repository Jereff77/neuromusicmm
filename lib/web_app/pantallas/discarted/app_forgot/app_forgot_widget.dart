...
import 'app_forgot_model.dart';
export 'app_forgot_model.dart';

class AppForgotWidget extends StatefulWidget {
  const AppForgotWidget({super.key});

  @override
  State<AppForgotWidget> createState() => _AppForgotWidgetState();
}

class _AppForgotWidgetState extends State<AppForgotWidget> {
  late AppForgotModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AppForgotModel());
